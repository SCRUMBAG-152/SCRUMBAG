...
import wizardStyle from "../../customs/assets/jss/material-dashboard-pro-react/components/wizardStyle.jsx";
...
class Wizard extends React.Component {
  ...
  finishButtonClick() {
    const project = {
      title: this.state.allStates[0].about.title,
      description: this.state.allStates[0].about.description,
      teamName:this.state.allStates[0].about.teamName,
      ...this.state.allStates[1].type
    }
    this.props.createProject(project)
    this.props.history.push("/projects")
    //const history = createBrowserHistory({forceRefresh:true});
    //setTimeout(history.push("/projects"), 0)
  }
...
export default withRouter(connect(null, mapDispatchToProps)(withStyles(wizardStyle)(Wizard)))